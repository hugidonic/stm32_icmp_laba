...
#define		ENC28J60_GPIO		(GPIOB)
#define		ENC28J60_nRST_Pin	(GPIO_Pin_0)
#define		ENC28J60_nINT_Pin	(GPIO_Pin_1)
#define		ENC28J60_nWOL_Pin	(GPIO_Pin_2)
#define		ENC28J60_nCS_Pin	(GPIO_Pin_12)
#define		ENC28J60_nSCK_Pin	(GPIO_Pin_13)
#define		ENC28J60_nSO_Pin	(GPIO_Pin_14)
#define		ENC28J60_nSI_Pin	(GPIO_Pin_15)
